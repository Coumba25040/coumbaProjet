...
//     } else {
//         echo 'Bonjour ' . htmlspecialchars($nom) . ', vous avez ' . (int)$age . ' ans.';
//     }
// }
...
echo'Manipulation de chaînes : Vérifie si une chaîne est un palindrome.
 ...
 function nombreMots($string){
    return 'Il y a ' . str_word_count(trim($string)) . ' mots <br>';
 }
...
echo'<br>-----------------------------------------------EXO 13 ---------------------------------------------<br>';
echo'Sessions et cookies
 → Crée une page avec un compteur de visites en utilisant les cookies.
 → Crée un système de connexion simple avec sessions (pseudo + mot de passe en dur). <br>'
