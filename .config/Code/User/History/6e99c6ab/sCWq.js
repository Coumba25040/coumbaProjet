...
// re utiliser la tabDestination ici à la place du tableau destination pour la flexibilité 
    ...
    <a href="#" class="btnSupprimer btn btn-primary" data-index="${index}">Supprimer</a>
  </div>
</div>`
...
const btnSupprimer = document.getElementsByClassName("btnSupprimer")
...
function guess(){
    ...
    let devine = prompt('devine le nombre')
