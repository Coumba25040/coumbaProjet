let candidatureContainer = document.getElementById('candidature-container')
    ...
    tabCandidature.forEach((item, index) => {
        ...
        btnModifier.forEach(btnM => {
            btnM.addEventListener('click', (e) => {
                ...
                entreprise.value = candidature[index].entreprise
                ville.value = candidature[index].ville
                poste.value = candidature[index].poste
                contact.value = candidature[index].contact
                email.value = candidature[index].email
                date.value = candidature[index].date 
                statut.value = candidature[index].statut
                description.value = candidature[index].description
