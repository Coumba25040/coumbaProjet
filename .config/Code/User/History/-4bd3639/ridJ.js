...
function afficherCard(tabCandidature){
    ...
    tabCandidature.forEach((item, index) => {
        ...
        candidatureContainer.scrollIntoView({behavior: 'smooth', block: 'start'})
...
const saveCandidature = localStorage.getItem('candidatures')

if(saveCandidature){
    candidature = JSON.parse(saveCandidature)
    afficherCard(candidature)
}

function saveLocalStorage(){
    localStorage.setItem('candidatures', JSON.stringify(candidature))
}
